...
FIND_PATH(NVCORE_INCLUDE_DIR nvcore/Memory.h
  PATHS
  /usr/local
  /usr
  $ENV{NVTT_DIR}
...
SET(NVTT_FOUND "NO")
IF(NVTT_LIBRARY AND NVTT_INCLUDE_DIR AND NVCORE_LIBRARY AND NVCORE_INCLUDE_DIR)
  SET(NVTT_LIBRARIES ${NVTT_LIBRARY} ${NVCORE_LIBRARY} )
  SET(NVTT_FOUND "YES")
  MESSAGE(STATUS "Found NVIDIA Texture Tools (NVTT): ${NVTT_LIBRARIES}")
ENDIF(NVTT_LIBRARY AND NVTT_INCLUDE_DIR AND NVCORE_LIBRARY AND NVCORE_INCLUDE_DIR)
